...
def test_all_routes_have_explicit_boundary_semantics() -> None:
    ...
    assert {(route.path, tuple(sorted(route.methods))) for route in routes} == {
        ...
        ("/api/dashboards/x", ("GET",)),
        ("/api/dashboards/linkedin", ("GET",)),
        ("/api/dashboards/youtube", ("GET",)),
        ("/api/health", ("GET",)),
        ("/api/insights", ("GET",)),
        ("/api/insights/generate", ("POST",)),
        ("/api/insights/limit", ("GET",)),
        ("/api/integrations/meta/accounts/link", ("POST",)),
        ("/api/settings/meta/accounts/link", ("POST",)),
        ...
        ("/api/integrations/linkedin/accounts/link", ("POST",)),
        ("/api/integrations/linkedin/accounts/unlink", ("DELETE",)),
        ("/api/integrations/linkedin/oauth/start", ("POST",)),
        ("/api/integrations/linkedin/self-service/readiness", ("GET",)),
        ...
        ("/api/integrations/youtube/self-service/readiness", ("GET",)),
        ...
        ("/api/platforms/x/accounts", ("GET",)),
        ("/api/platforms/linkedin/accounts", ("GET",)),
        ("/api/platforms/youtube/accounts", ("GET",)),
        ("/api/reports/xlsx", ("POST",)),
        ("/api/reports/xlsx/{job_id}", ("GET",)),
        ("/api/reports/xlsx/{job_id}/download", ("POST",)),
        ...
        ("/api/social/linkedin/oauth/callback", ("GET",)),
