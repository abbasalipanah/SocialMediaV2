            ...
            connection.execute(
                text(
                    """INSERT INTO content_items (
                        ...
                        reposts_count, quotes_count, clicks_count, link_clicks,
                        profile_clicks,
                    ...
                    ON CONFLICT (asset_id, content_id) DO UPDATE SET
                        ...
                        clicks_count=CASE WHEN :preserve_insights
                            THEN content_items.clicks_count ELSE EXCLUDED.clicks_count END,
        ...
        with self.engine.connect() as connection:
            rows = connection.execute(
                text(
                    """SELECT i.asset_id, i.brand_id, a.platform, i.content_id,
                              ...
                              i.reposts_count, i.quotes_count, i.clicks_count,
                              i.link_clicks,
            ...
            return tuple(
                ContentRecord(
                    ...
                    clicks_count=_optional_int(row["clicks_count"]),
