...
CONTAINER="social-media-v2-phase3-$$"
PASSWORD="disposable_phase3_password"
...
"$ROOT/scripts/quality/fase2_contract_check.sh"
...
"$ROOT/scripts/source_write_guard.sh"
echo "OK: Faz 3 authority projection certification passed."
