...
CONTAINER="social-media-v2-phase6-$$"
PASSWORD="disposable_phase6_password"
...
"$ROOT/scripts/quality/fase5_collector_parity_check.sh"
...
"$ROOT/scripts/source_write_guard.sh"
echo "OK: Faz 6 dashboard and operations API certification passed."
